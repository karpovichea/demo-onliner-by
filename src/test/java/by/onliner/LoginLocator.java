...
public class LoginLocator {
    ...
    public static final String EMPTY_LOGIN_ERROR_MESSAGE = "//div[@class='auth-form__description auth-form__description_error auth-form__description_base auth-form__description_extended-other']";
